...
@Component
public class LocalDeepSeekComponent implements AIComponent {
    ...
    public String jsonCall(AIModel aiModel, RequestPayload requestPayload) throws Exception {
        ...
        try {
            ...
            logger.info(">>>>>>use deepseek LocalDeepSeekComponent call json with RequestPayload");
            ...
            throw new Exception(
                    ">>>>>>use LocalDeepSeekComponent jsonCall with RequestPayload error->" + e.getMessage(), e);
        }
    }
    ...
    public String jsonCall(AIModel aiModel, String promptStr, double temperature) throws Exception {
        ...
        try {
            ...
            throw new Exception(">>>>>>use LocalDeepSeekComponent jsonCall error->" + e.getMessage(), e);
        }
    }
    ...
    public CompleteResponse doRequestWithStream(String userName, AIModel aiModel, RequestPayload request, CompleteCallback callback) {
        ...
        try {
            RealEventSource realEventSource = new RealEventSource(httpRequest, new EventSourceListener() {
                ...
                public void onEvent(EventSource eventSource, String id, String type, String data) {
                    try {
                        ...
                        logger.error("LocalDeepSeekComponent 处理SSE事件数据失败", e);
                    }
                }
                ...
                public void onFailure(EventSource eventSource, Throwable t, Response response) {
                    try {
                        ...
                        logger.error(">>>>>>deep seek聊天访问失败", t);
                        if (callback != null) {
            ...
            logger.error(">>>>>>LocalDeepSeekComponent调用失败->{}", e.getMessage());
            if (callback != null) {
